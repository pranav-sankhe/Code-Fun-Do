...
intents.matches(/^change name/i, [
    function (session) {
        session.beginDialog('/profile2');
    },
    function (session, results) {
        session.send('Ok... Changed your name to getTime%s', session.userData.name);
    }
]);
...
bot.dialog('/profile2', [
    function (session) {
        builder.Prompts.text(session, 'Hi!your changed name?');
    },
    function (session, results) {
        session.userData.name = results.response;
        session.endDialog();
...
//var model = process.env.model || 'https://api.projectoxford.ai/luis/v2.0/apps/c7cf5119-fd8c-4838-869f-be1221d61521?subscription-key=62383e07722f440f9ffd28c4cb7ba535&q=taking%20medicine%20time&verbose=true';
bot.recognizer(new builder.LuisRecognizer('https://api.projectoxford.ai/luis/v2.0/apps/c413b2ef-382c-45bd-8ff0-f76d60e2a821?subscription-key=62383e07722f440f9ffd28c4cb7ba535&q='));
